...
export default function Home(){
 ...
 function exportTrace(){const blob=new Blob([JSON.stringify(createGameTrace({intent,invariant,mode,source:sourcePhases[source],metrics,gradient,coherence,log}),null,2)],{type:"application/json"});const u=URL.createObjectURL(blob),a=document.createElement("a");a.href=u;a.download="subject-core-trace.json";document.body.appendChild(a);a.click();a.remove();setTimeout(()=>URL.revokeObjectURL(u),1000)}
